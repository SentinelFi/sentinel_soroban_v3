...
/* Texts mirror dapp/src/pages/Legal.tsx — keep the two in sync. */
    ...
    <LegalShell title="Privacy Policy" updated="July 2026">
      ...
      <Section heading="What we collect">
        ...
        <ul className="mt-2 list-disc space-y-1 pl-6">
          <li>
            Your Stellar public address is used to build and submit
            transactions.
          </li>
          <li>
            Policy and vault parameters are recorded on-chain as contract
            state.
          </li>
          <li>
      ...
      <Section heading="Blockchain data">
        <p>
          All Stellar transactions are public and immutable &mdash; policy
          purchases, vault deposits and withdrawals, and settlements. On-chain
          data cannot be deleted or modified by us.
        </p>
      </Section>
      ...
      <Section heading="Contact">
        <p>
          ...
          <a
            ...
            className="text-highlight transition-colors hover:text-white"
          >
            GitHub
          </a>
          .
  ...
  return (
    <LegalShell title="Terms of Service" updated="July 2026">
      <Section heading="Acceptance">
        <p>
          By using this interface you agree to these terms. If you do not
          agree, do not use it. This is experimental, early-stage software
          provided on an "as is" basis with no warranties of any kind.
        </p>
      </Section>
      ...
      <Section heading="How the protocol works">
        <ul className="mt-2 list-disc space-y-1 pl-6">
          ...
          <li>
            Underwriting deposits capital into a shared pool that earns
            premiums and absorbs payouts.
          </li>
          <li>
      ...
      <Section heading="Limitation of liability">
        <p>
          ...
          liable for any loss or damage arising from your use of the protocol
          or this interface.
        </p>
      </Section>
    </LegalShell>
    ...
    <LegalShell title="Disclaimers" updated="August 2026">
      <Section heading="Scope">
        <p>
          ...
          other material published around this protocol. Reading, browsing, or
          transacting through this interface means you accept them.
        </p>
      </Section>
      <Section heading="Nothing here is advice">
        <p>
          Everything on this site is general information. None of it is &mdash;
          or should be read as &mdash; investment, financial, legal, tax,
          accounting, or insurance advice, and nothing here recommends that you
          buy cover, deposit into the vault, or hold any digital asset. Talk to
          a qualified professional before making decisions that depend on your
          personal situation.
        </p>
      </Section>
      <Section heading="An autonomous protocol, not a company">
        <p>
          ...
          those contracts &mdash; the protocol exists and operates without it.
        </p>
      </Section>
      <Section heading="No affiliation">
        <p>
          Independent, not affiliated with the Stellar Development Foundation.
          This project builds on the Stellar network and its open-source
          tooling, but it is not sponsored, endorsed, or operated by the
          Stellar Development Foundation; "Stellar" and "Soroban" are
          referenced only to describe where the protocol runs.
        </p>
      </Section>
      ...
      <Section heading="Risk of loss">
        <p>
          ...
          contain defects even after review; oracles and the flight data behind
          them can be late, incomplete, or wrong; stablecoins can trade away
          from their peg; and network congestion or outages can delay
          settlement. Premiums you stake and capital you underwrite with can be
          lost entirely. Commit only what you can afford to lose.
        </p>
      </Section>
      <Section heading="Independent third parties">
        <p>
          Wallets, RPC endpoints, block explorers, bridges, aviation data
          providers, and other services reachable from this interface are built
          and operated by independent parties. Links to them are provided for
          convenience: the contributors have not audited them and do not
          endorse or guarantee their security, availability, or accuracy.
        </p>
      </Section>
      <Section heading="Estimates and forward-looking figures">
        <p>
          Some numbers shown in this interface &mdash; delay-risk estimates,
          trend sparklines, projected yields &mdash; are labelled as estimates
          or illustrative series. They are not measured history and not a
          promise of future performance; any forward-looking figure is
          inherently uncertain and can turn out to be wrong.
        </p>
      </Section>
      <Section heading="Regulatory status">
        <p>
          ...
          Nothing published here is an offer or solicitation in any place where
          such an offer would be unlawful, and the protocol is not presented as
          a licensed or regulated financial or insurance service. It is your
          responsibility to confirm that using it is lawful where you live and
      ...
      <Section heading="No warranties, no liability">
        <p>
          ...
          accept no liability for any loss or damage &mdash; direct or
          indirect, including lost assets or lost profits &mdash; arising from
          your use of, or inability to use, the protocol or this interface.
        </p>
      </Section>
    </LegalShell>
  );
