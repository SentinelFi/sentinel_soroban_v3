...
/**
 * Pixel info bubble: a bordered "?" square that toggles a small bordered
 * panel. The panel is mounted/unmounted on toggle — never opacity-gated —
 * so its content is fully visible whenever it exists.
 */
	...
	return (
		<span ref={rootRef} className="relative inline-flex">
			<button
				...
				title="What is this?"
				onClick={() => setOpen((o) => !o)}
				className={`flex h-6 w-6 items-center justify-center border-2 font-display text-[10px] leading-none transition-none ${
					open
			...
			{open && (
				<div
					role="note"
					className="panel-raised absolute left-1/2 top-full z-30 mt-2 w-[19rem] max-w-[80vw] -translate-x-1/2 p-4 text-left normal-case tracking-normal sm:w-[21rem]"
				>
					<p className="label-px mb-2 text-gold">
						HOW THIS WORKS
					</p>
